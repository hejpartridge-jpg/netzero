...
from emission_factors import GAS_MONTHLY_WEIGHTING, ELECTRICITY_MONTHLY_WEIGHTING, ELECTRICITY_MONTHLY_FACTORS, SOLAR_MONTHLY_FACTORS, GAS_MONTHLY_FACTORS

def build_initial_state(profile: dict) -> dict:

## combined billing vs separate billing to get yearly gas/electricity kWh
    ...
    ## water monthly spend to yearly usage
    ...
    #where the heating comes from and how much energy is used for heating
    if profile.get("fuel_type") == "heat_pump":
        heating_baseline = yearly_elec_kwh * 0.78 #heating vs appliances split
